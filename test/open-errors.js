...
// options
Mcp9808.open('not an options object').then((sensor) => {
  assert(false, 'Expected open to reject invalid options object.');
}).catch((err) => {
...
// i2cBusNumber
Mcp9808.open({i2cBusNumber: 'a string'}).then((sensor) => {
  assert(false, 'Expected open to reject invalid i2cBusNumber.');
}).catch((err) => {
...
Mcp9808.open({i2cBusNumber: -1}).then((sensor) => {
  assert(false, 'Expected open to reject invalid i2cBusNumber.');
}).catch((err) => {
...
Mcp9808.open({i2cBusNumber: 1.5}).then((sensor) => {
  assert(false, 'Expected open to reject invalid i2cBusNumber.');
}).catch((err) => {
...
// i2cAddress
Mcp9808.open({i2cAddress: 'a string'}).then((sensor) => {
...
Mcp9808.open({i2cAddress: -1}).then((sensor) => {
  assert(false, 'Expected open to reject invalid i2cAddress.');
}).catch((err) => {
...
Mcp9808.open({i2cAddress: 1.5}).then((sensor) => {
  assert(false, 'Expected open to reject invalid i2cAddress.');
}).catch((err) => {
...
// alertGpioNumber
Mcp9808.open({alertGpioNumber: 'a string'}).then((sensor) => {
  assert(false, 'Expected open to reject invalid alertGpioNumber.');
}).catch((err) => {
...
Mcp9808.open({alertGpioNumber: -1}).then((sensor) => {
  assert(false, 'Expected open to reject invalid alertGpioNumber.');
}).catch((err) => {
...
Mcp9808.open({alertGpioNumber: 1.5}).then((sensor) => {
  assert(false, 'Expected open to reject invalid alertGpioNumber.');
}).catch((err) => {
...
Mcp9808.open({lowerAlertTemperature: 'a string'}).then((sensor) => {
  assert(false, 'Expected open to reject invalid lowerAlertTemperature.');
}).catch((err) => {
...
Mcp9808.open({lowerAlertTemperature: -300}).then((sensor) => {
  assert(false, 'Expected open to reject invalid lowerAlertTemperature.');
}).catch((err) => {
...
Mcp9808.open({upperAlertTemperature: 'a string'}).then((sensor) => {
  assert(false, 'Expected open to reject invalid upperAlertTemperature.');
}).catch((err) => {
...
Mcp9808.open({upperAlertTemperature: -400}).then((sensor) => {
  assert(false, 'Expected open to reject invalid upperAlertTemperature.');
}).catch((err) => {
...
// criticalTemperature
Mcp9808.open({criticalTemperature: 'a string'}).then((sensor) => {
  assert(false, 'Expected open to reject invalid criticalTemperature.');
}).catch((err) => {
...
Mcp9808.open({criticalTemperature: -500}).then((sensor) => {
  assert(false, 'Expected open to reject invalid criticalTemperature.');
}).catch((err) => {
...
// resolution
Mcp9808.open({resolution: 'a string'}).then((sensor) => {
  assert(false, 'Expected open to reject invalid resolution.');
}).catch((err) => {
...
Mcp9808.open({resolution: -1}).then((sensor) => {
  assert(false, 'Expected open to reject invalid resolution.');
}).catch((err) => {
...
Mcp9808.open({resolution: 4}).then((sensor) => {
  assert(false, 'Expected open to reject invalid resolution.');
}).catch((err) => {
...
// hysteresis
Mcp9808.open({hysteresis: 'a string'}).then((sensor) => {
  assert(false, 'Expected open to reject invalid hysteresis.');
}).catch((err) => {
...
Mcp9808.open({hysteresis: -1}).then((sensor) => {
  assert(false, 'Expected open to reject invalid hysteresis.');
}).catch((err) => {
...
Mcp9808.open({hysteresis: 4}).then((sensor) => {
  assert(false, 'Expected open to reject invalid hysteresis.');
}).catch((err) => {
...
// alert temperatures
Mcp9808.open({lowerAlertTemperature: 20}).then((sensor) => {
  assert(false, 'Expected open to reject if correct number of alert temperatures not specified.');
}).catch((err) => {
...
Mcp9808.open({lowerAlertTemperature: 20, upperAlertTemperature: 30}).then((sensor) => {
  assert(false, 'Expected open to reject if correct number of alert temperatures not specified.');
}).catch((err) => {
  if (err.message !== 'Expected all alert temperatures or no alert temperatures to be specified.') {
    console.log(err.stack);
...
Mcp9808.open({upperAlertTemperature: 30, criticalTemperature: 40}).then((sensor) => {
  assert(false, 'Expected open to reject if correct number of alert temperatures not specified.');
}).catch((err) => {
  if (err.message !== 'Expected all alert temperatures or no alert temperatures to be specified.') {
    console.log(err.stack);
...
Mcp9808.open({lowerAlertTemperature: 30, upperAlertTemperature: 30, criticalTemperature: 40}).then((sensor) => {
  assert(false, 'Expected open to reject bad temperatures.');
}).catch((err) => {
...
Mcp9808.open({lowerAlertTemperature: 20, upperAlertTemperature: 40, criticalTemperature: 40}).then((sensor) => {
  assert(false, 'Expected open to reject bad temperatures.');
}).catch((err) => {
